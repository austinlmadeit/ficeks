...
export const DAILY_CHANGE_LOG = [
  {
    ...
    changes: [
      ...
      'Rebuilt Brandon Office Locations page (/about/locations) featuring 1439 1st Street as Main Headquarters and 1525 18th Street as secondary branch location.',
