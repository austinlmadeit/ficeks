...
export const DAILY_CHANGE_LOG = [
  {
    ...
    changes: [
      ...
      'Rebuilt Brandon Office Locations page (/about/locations) featuring 1439 1st Street as Main Headquarters and 1550A Richmond Avenue (Murray Chrysler Building) as branch office.',
      'Configured dual-office showcase cards with direct Google Maps directions links, phone routing, hours, and client amenities checklist.',
