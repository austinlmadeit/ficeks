...
// ── Find Us: in-depth location guides (/find-us) ──
// NOTE FOR REVIEW: items marked `confirm: true` are drafted from Brandon's
// major routes and still need verifying by the team. What is left is the
// transit wording for each office; the parking details and the Shoppers Mall
// landmark have been confirmed. Everything else comes from OFFICES above.
export const LOCATION_GUIDES = [
  {
    officeId: 'eighteenth',
    shortName: '18th Street',
    eyebrow: 'Our New Location',
    isNew: true,
    summary:
      'Our newest Brandon office sits on 18th Street, the busiest north-south corridor in the city, so it is an easy stop whether you are heading in off the highway or crossing town after work. Extended evening hours make it the best choice if you cannot get away during the day.',
    corridor: {
      title: '18th Street is Provincial Trunk Highway 10',
      body:
        '18th Street doubles as PTH 10, the main route running north and south through Brandon and on toward Riding Mountain in the north and Boissevain in the south. If you can find 18th Street, you can find us: we are in the south end of the strip, between Humpty\u2019s and South End Service.',
    },
    routes: [
      {
        from: 'From the Trans-Canada Highway (PTH 1)',
        steps: [
          'Take the 18th Street / PTH 10 exit and head south into the city.',
          'Stay on 18th Street through the Victoria Avenue lights, then continue south past Richmond Avenue.',
          'Watch for Humpty\u2019s and South End Service: our office is in the 1525 block between them.',
        ],
      },
      {
        from: 'From downtown Brandon (Rosser Avenue)',
        steps: [
          'Head west on Rosser Avenue or Princess Avenue to 18th Street.',
          'Turn south (left) onto 18th Street.',
          'Continue south through Victoria Avenue and Richmond Avenue to the 1525 block.',
        ],
      },
      {
        from: 'From the east side (Kirkcaldy Heights, Maryland Park)',
        steps: [
          'Take Victoria Avenue west across the city to 18th Street.',
          'Turn south (left) onto 18th Street.',
          'Drive south past Richmond Avenue and watch for our sign on the 1525 block.',
        ],
      },
      {
        from: 'From the west and south (Green Acres, Riverheights, Brandon Hills)',
        steps: [
          'Take Richmond Avenue east to 18th Street.',
          'Turn south (right) onto 18th Street.',
          'We are a short drive down, between Humpty\u2019s and South End Service.',
        ],
      },
    ],
    landmarks: [
      { label: 'Humpty\u2019s Restaurant', note: 'Directly beside us on the north side.' },
      { label: 'South End Service', note: 'Directly beside us on the south side.' },
      { label: 'Shoppers Mall', note: 'Directly west of us.' },
      { label: 'Richmond Avenue lights', note: 'The last major intersection before you reach us.' },
    ],
    parking: {
      title: 'Parking and entrance',
      body:
        'We have marked customer stalls reserved for Ficek Insurance clients, right out front of the office. Our unit is 1525B, so look for the B entrance along the storefront.',
    },
    transit: {
      title: 'Transit and walking',
      body:
        'Brandon Transit runs service along the 18th Street corridor, and the stop nearest Richmond Avenue leaves a short walk to our door. Check brandon.ca for current routes and times.',
      confirm: true,
    },
    bestFor: [
      'Evening appointments: we are open until 7:00 PM Monday through Friday.',
      'Saturday Autopac renewals and driver licensing, 10:00 AM to 5:00 PM.',
      'Anyone coming in off the highway or from the south end of the city.',
    ],
    gallery: [
      {
        src: '/images/buildings/18th-street-pylon-sign.jpg',
        alt: 'The tall roadside sign on 18th Street listing Petro-Pass, South End Service, Ficek Insurance with Autopac, and Humpty\u2019s Big Plate Diner.',
        caption: 'Watch for this sign from 18th Street. Our panel sits between South End Service and Humpty\u2019s.',
      },
      {
        src: '/images/buildings/18th-street-from-the-street.jpg',
        alt: 'The strip on 18th Street in Brandon seen from across the road: Humpty\u2019s on the left, Ficek Insurance and Autopac in the middle, and South End Service on the right.',
        caption: 'What the block looks like from 18th Street. We are in the middle, between Humpty\u2019s and South End Service.',
      },
      {
        src: '/images/buildings/18th-street-storefront.jpg',
        alt: 'The 1525B storefront: the Ficek Insurance shield and Autopac sign above a black sign reading Home, Business, Farm, Travel, with the glass entrance door below.',
        caption: 'Our door is 1525B, under the Home, Business, Farm, Travel sign.',
      },
      {
        src: '/images/buildings/18th-street-parking.jpg',
        alt: 'The parking lot in front of the 1525B 18th Street office, with open stalls directly outside the Ficek Insurance entrance and South End Service next door.',
        caption: 'Look for the marked stalls reserved for Ficek Insurance customers, right out front of our door.',
      },
      {
        src: '/images/buildings/18th-street-interior-counter.jpg',
        alt: 'Inside the 18th Street office: a row of numbered service wickets along a wood counter, under the Ficek Insurance sign on the blue feature wall.',
        caption: 'Inside, our numbered service wickets handle Autopac renewals and driver licensing.',
      },
      {
        src: '/images/buildings/18th-street-interior-waiting.jpg',
        alt: 'The 18th Street office interior looking toward the seating area, with chairs along the wall beside the service counters.',
        caption: 'Seating is just inside the door if you need to wait for a broker.',
      },
    ],
  },
  {
    officeId: 'main',
    shortName: '1st Street',
    eyebrow: 'Main Office HQ',
    isNew: false,
    corridor: {
      title: '1st Street runs the length of the city',
      body:
        '1st Street is one of Brandon\u2019s main north-south routes, carrying traffic from the Assiniboine River crossing in the north down through downtown to the south end. Our building is in the 1439 block, near the Richmond Avenue intersection.',
    },
    routes: [
      {
        from: 'From the Trans-Canada Highway (PTH 1)',
        steps: [
          'Come south into the city on 18th Street (PTH 10) or 1st Street.',
          'If you took 18th Street, turn east onto Victoria Avenue or Richmond Avenue.',
          'Turn south onto 1st Street and continue to the 1439 block near Richmond Avenue.',
        ],
      },
      {
        from: 'From downtown Brandon',
        steps: [
          'Head south on 1st Street from Rosser Avenue.',
          'Cross Princess Avenue and Victoria Avenue, staying on 1st Street.',
          'We are in the 1439 block as you approach Richmond Avenue.',
        ],
      },
      {
        from: 'From the east side of the city',
        steps: [
          'Take Richmond Avenue or Victoria Avenue west toward 1st Street.',
          'Turn onto 1st Street and watch for the 1439 block.',
        ],
      },
      {
        from: 'From the south end (Corral Centre, Brandon Hills)',
        steps: [
          'Head north on 1st Street.',
          'Continue past Richmond Avenue and look for our building on the 1439 block.',
        ],
      },
    ],
    landmarks: [
      { label: '1st Street and Richmond Avenue', note: 'The main intersection to navigate to.' },
      { label: 'Victoria Avenue', note: 'The cross street just north of us on 1st Street.' },
      { label: 'Downtown Brandon', note: 'A straight run north on 1st Street.' },
    ],
    parking: {
      title: 'Parking and entrance',
      body:
        'We have marked customer stalls reserved for Ficek Insurance clients at the building. Watch for the Ficek Insurance Parking signs pointing the way in.',
    },
    transit: {
      title: 'Transit and walking',
      body:
        'The 1st Street corridor is served by Brandon Transit and is an easy walk from the downtown core. Check brandon.ca for current routes and times.',
      confirm: true,
    },
    gallery: [
      {
        src: '/images/buildings/1st-street-01.jpg',
        alt: 'The Ficek Insurance building at 1439 1st Street, Brandon, seen from the Richmond Avenue corner, with the Ficek Insurance and Autopac sign on a post at the street.',
        caption: 'Our building at the 1st Street and Richmond Avenue corner. Watch for the Ficek Insurance and Autopac sign.',
      },
      {
        src: '/images/buildings/1st-street-02.jpg',
        alt: 'The 1439 1st Street office viewed from across the street, showing the Ficek Insurance Autopac sign, the front entrance and the client parking lot beside the building.',
        caption: 'Marked customer parking sits right beside the building, a few steps from the door.',
      },
    ],
  },
];

// Communities served from both Brandon offices
...
export const CARRIERS = [
  ...
  { id: '3', name: 'SGI Canada', logo: '/images/carriers/sgi.updated.webp', url: 'https://www.sgicanada.ca' },
