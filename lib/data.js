...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    rating: 5,
    quote: 'Switched from another broker and saved over $400 a year on our home and auto bundle. The staff were incredibly patient walking us through all the options.',
  },
  {
    author: 'Mike P.',
    location: 'Rivers, MB',
    ...
    rating: 5,
    quote: 'Been with Ficek Insurance for over 15 years. They always go above and beyond when it comes to making sure our farm is properly covered. Highly recommend.',
  },
  {
    author: 'Angela & Rob D.',
    location: 'Brandon, MB',
    ...
    rating: 5,
    quote: 'Bought our first condo and had no idea what we needed for insurance. The team at Ficek made it easy and affordable. Great experience from start to finish.',
  },
  {
    author: 'Chris L.',
    location: 'Brandon, MB',
    service: 'Commercial Auto Fleet',
    rating: 5,
    quote: 'Managing insurance for a fleet of delivery vehicles is no joke. Ficek handles everything seamlessly and always finds us competitive rates. Wouldn\'t go anywhere else.',
  },
];
