...
export const MPI_FORMS = [
  {
    ...
    items: [
      ...
      {
        title: 'Authorize Someone Else to Insure & Register Your Vehicle',
        desc: 'Appointment of representative form allowing another person to complete MPI registration for you.',
