...
export const LOCATION_GUIDES = [
  {
    ...
    landmarks: [
      ...
      { label: 'Shoppers Mall', note: 'Just north of us at 18th Street and Richmond Avenue.', confirm: true },
  ...
  },
  {
    ...
    isNew: false,
    summary:
      'Our original Brandon office has been at 1st Street since the family opened the doors in 1986. It sits on the 1st Street corridor near Richmond Avenue, an easy run straight south from downtown and a familiar stop for generations of Brandon clients.',
    corridor: {
    ...
    bestFor: [
      'Long-standing clients who have always dealt with our main office.',
      'Commercial, farm, and fleet files handled by our senior brokers.',
      'Anyone coming from downtown or the north end of Brandon.',
    ],
    gallery: [],
  },
];
