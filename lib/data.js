...
export const TEAM = [
  {
    name: 'Rod & Heather Ficek',
    title: 'Owners',
    category: 'Leadership & Founders',
    bio: 'Founding owners who established Ficek Insurance on family values, dedicated community care, and honest broker advice across Brandon and Westman.',
  },
  {
    name: 'Danon Ficek',
    title: 'General Manager',
    category: 'Leadership & Founders',
    bio: 'Leading agency operations and carrying forward the second-generation family leadership at Ficek Insurance.',
  },
  {
    name: 'Sabrina Bambridge',
    title: 'Human Resources',
    category: 'Leadership & Founders',
    bio: 'Managing team development, human resources, and client experience standards across our Brandon locations.',
  },
  {
    name: 'Beatriz Rodrigues da Silva',
    title: 'Office Manager',
    category: 'Management & Support',
    bio: 'Overseeing daily office operations, administration, and ensuring seamless service for all Ficek clients.',
  },
  {
    name: 'Micheal Okunbo',
    title: 'Administrative Officer',
    category: 'Management & Support',
    bio: 'Coordinating administrative operations, policy processing support, and client documentation.',
  },
  {
    name: 'Brian Keown',
    title: 'Insurance Broker',
    category: 'Licensed Insurance Brokers',
    bio: 'Licensed insurance broker providing expert advice across personal lines, auto, home, and commercial coverage.',
  },
  {
    name: 'Linda Olaojo',
    title: 'Insurance Broker',
    category: 'Licensed Insurance Brokers',
    bio: 'Licensed insurance broker dedicated to helping Brandon families find tailored home, auto, and Autopac solutions.',
  },
  {
    name: 'Brooke McCannell',
    title: 'Insurance Broker',
    category: 'Licensed Insurance Brokers',
    bio: 'Licensed insurance broker committed to clear communication, policy reviews, and client risk management.',
  },
  {
    name: 'Austin Liske',
    title: 'Insurance Broker',
    category: 'Licensed Insurance Brokers',
    bio: 'Licensed insurance broker specializing in personalized insurance consultations, quote analysis, and policy optimization.',
  },
  {
    name: 'Manas Sidana',
    title: 'Insurance Broker',
    category: 'Licensed Insurance Brokers',
    bio: 'Licensed insurance broker focused on comprehensive coverage for auto, property, and commercial assets.',
  },
  {
    name: 'Adrian Calucod',
    title: 'Insurance Broker',
    category: 'Licensed Insurance Brokers',
    bio: 'Licensed insurance broker providing friendly, knowledgeable service and prompt claims guidance for Manitoba drivers and homeowners.',
  },
  {
    name: 'Zarina Villanueva',
    title: 'Insurance Broker',
    category: 'Licensed Insurance Brokers',
    bio: 'Licensed insurance broker passionate about protecting local Brandon families and business owners.',
  },
];
