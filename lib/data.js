...
export const OFFICES = [
  {
    id: 'main',
    name: '1st Street Main Office (Headquarters)',
    street: '1439 1st Street',
  ...
  {
    id: 'richmond',
    name: 'Richmond Avenue Office (Murray Chrysler)',
    street: '1550A Richmond Avenue',
    crossStreet: 'Murray Chrysler Building (Murray Auto Group)',
    city: 'Brandon',
    province: 'MB',
    postal: 'R7A 7E3',
    full: '1550A Richmond Avenue, Brandon, MB R7A 7E3',
    phone: '204-571-1777',
    phoneHref: 'tel:+12045711777',
    email: 'info@ficekinsurance.com',
    badge: '📍 Murray Auto Group Branch',
    desc: 'Conveniently located inside the Murray Chrysler complex on Richmond Ave for Autopac registration, vehicle transfers, and personal insurance.',
    hours: 'Monday – Friday: 9:00 AM – 5:00 PM',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=1550A+Richmond+Avenue+Brandon+MB',
    embedUrl: 'https://maps.google.com/maps?q=1550A%20Richmond%20Avenue%20Brandon%20MB&t=&z=15&ie=UTF8&iwloc=&output=embed',
  },
];
