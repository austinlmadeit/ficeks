...
export const CARRIERS = [
  { id: '1', name: 'Red River Mutual', category: 'Home & Property', badge: 'Mutual Partner', url: 'https://redrivermutual.com/' },
  { id: '2', name: 'Sandbox Mutual Insurance', category: 'Home & Commercial', badge: 'Mutual Partner', url: 'https://sandbox.ca/' },
  { id: '3', name: 'SGI Canada', category: 'Auto & Commercial', badge: 'National Partner', url: 'https://www.sgicanada.ca' },
  { id: '4', name: 'Optimum General Insurance', category: 'Personal & Business', badge: 'Regional Partner', url: 'https://www.optimum-general.com' },
  { id: '5', name: 'Milnco Insurance Broker Solution Centre', category: 'Broker Solutions', badge: 'Specialty MGA', url: 'https://www.milnco.ca/' },
  { id: '6', name: 'Trans Canada Insurance Marketing', category: 'Marketing & MGA', badge: 'Specialty MGA', url: 'https://www.tcim.ca/' },
  { id: '7', name: 'Premier', category: 'Commercial & Property', badge: 'Premier MGA', url: 'https://premiergroup.ca' },
  { id: '8', name: 'ABEX Insurance', category: 'Specialist Lines', badge: 'Specialist MGA', url: 'https://www.abexinsurance.com/' },
  { id: '9', name: 'Aurora Underwriting Services', category: 'Commercial & Niche', badge: 'Underwriting MGA', url: 'https://www.auroraunderwriting.com' },
  { id: '10', name: 'Beacon Underwriting', category: 'Marine & Specialty', badge: 'Specialty MGA', url: 'https://beacon.insure' },
  { id: '11', name: 'CHES Special Risk', category: 'High Risk & Niche', badge: 'Special Risk MGA', url: 'https://www.chesspecialrisk.ca/' },
  { id: '12', name: 'Chutter Underwriting Services', category: 'Liability & Commercial', badge: 'Underwriting MGA', url: 'https://www.chutteruw.com' },
  { id: '13', name: 'Totten Insurance Group', category: 'Specialty & Commercial', badge: 'National MGA', url: 'https://www.tottengroup.com' },
  { id: '14', name: 'ODIS Underwriting Inc', category: 'Commercial Lines', badge: 'Underwriting MGA', url: 'https://odis.ca/' },
  { id: '15', name: 'PAL Insurance Brokers Canada', category: 'Events & Specialty', badge: 'Specialty MGA', url: 'https://www.palcanada.com/' },
  { id: '16', name: 'Risk-Can Underwriting Managers', category: 'Commercial & Risk', badge: 'Underwriting MGA', url: 'https://www.riskcan.ca/' },
  { id: '17', name: 'Strategic Underwriting Managers', category: 'Commercial MGA', badge: 'Specialty MGA', url: 'https://www.suminsurance.ca' },
  { id: '18', name: 'Western Surety Company', category: 'Contractor & Surety', badge: 'Surety Bonds', url: 'https://www.westernsurety.ca' },
];
