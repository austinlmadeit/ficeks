...
export const LOCATION_GUIDES = [
  {
    ...
    parking: {
      ...
      body:
        'We have marked customer stalls reserved for Ficek Insurance clients, right out front of the office. Our unit is 1525B, so look for the Ficek logo along the storefront.',
    },
    transit: {
