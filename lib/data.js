...
// major routes and should be verified by the team before going live —
// specifically which side of the street each building sits on, the parking
// details, and the transit notes. Everything else comes from OFFICES above.
export const LOCATION_GUIDES = [
  {
    ...
    parking: {
      ...
      body:
        'Free surface parking is available on site, directly in front of the building. Our unit is 1525B, so look for the B entrance along the storefront.',
      confirm: true,
    },
    transit: {
    ...
    gallery: [
      ...
      },
      {
        ...
        caption: 'Park right out front. The lot is shared with the neighbouring businesses.',
      },
    ],
  },
  {
    ...
    parking: {
      title: 'Parking and entrance',
      body:
        'Client parking is available at the building, with additional street parking nearby on 1st Street.',
      confirm: true,
    },
    transit: {
      title: 'Transit and walking',
    ...
    gallery: [
      ...
      },
      {
        ...
        caption: 'Client parking sits right beside the building, a few steps from the door.',
      },
    ],
  },
];
